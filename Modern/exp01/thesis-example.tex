...
% **************************************************
\newcommand{\thesisTitle}{电子自旋共振}
\newcommand{\thesisName}{乔颢}
\newcommand{\thesisSubject}{实验报告}
\newcommand{\thesisDate}{March 13, 2014}
\newcommand{\thesisVersion}{0.2.2}

\newcommand{\thesisFirstReviewer}{王常生}
\newcommand{\thesisFirstReviewerUniversity}{\protect{北京大学}}
\newcommand{\thesisFirstReviewerDepartment}{凝聚态物理与材料物理研究所}

%\newcommand{\thesisSecondReviewer}{John Doe}
%\newcommand{\thesisSecondReviewerUniversity}{\protect{Clean Thesis Style University}}
%\newcommand{\thesisSecondReviewerDepartment}{Department of Clean Thesis Style}

\newcommand{\thesisFirstSupervisor}{王常生}
\newcommand{\thesisSecondSupervisor}{}

\newcommand{\thesisUniversity}{\protect{The Peking University}}
\newcommand{\thesisUniversityDepartment}{物理学院}
\newcommand{\thesisUniversityInstitute}{实验教学中心}
\newcommand{\thesisUniversityGroup}{近代物理实验}
\newcommand{\thesisUniversityCity}{北京}
\newcommand{\thesisUniversityStreetAddress}{颐和园路5号}
\newcommand{\thesisUniversityPostalCode}{100871}
